        ...
        child: GestureDetector(
          onTap: (){
            showModalBottomSheet<dynamic>(
              ...
              return Container(
                height: MediaQuery.of(context).size.height-240, //get the height up to curve
                child:Stack(
                  children: [
                    Positioned(
                      bottom: 0,
                    ...
                    Positioned(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          onTap: (){Navigator.pop(context);}, //removes the cover (X)
                          ),
    ...
    return Positioned(
        ...
        child: MediaQuery.removePadding(
          ...
          child: ListView.builder(
            itemCount: _controller.list.length,  // repeat list 3 times
            itemBuilder: (_, index) {
              return Container(
                margin: const EdgeInsets.only(top: 20, right: 20),
                height: 110, //default was 130 <Adjusted due to screen size>
                              ...
                              children: [
                                GestureDetector(
                                  ...
                                  child: Container(
                                      width: 80,
                                      height: 30,
                                      //decorating the box here
                                      decoration: BoxDecoration(
                                          borderRadius: BorderRadius.circular(30),
                                          color: _controller.list[index]["status"]==false?AppColor.selectBackground:AppColor.green),//if its true change color(its selected)
                                      child: Center(
                                        //the word "select"
                                        child: Text("Select",
                                            style: TextStyle(
